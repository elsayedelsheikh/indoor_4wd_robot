...
def main():
    ...
    waypoints = read_poses_from_yaml(waypoints_file_path)

    # Set our demo's initial pose
    # initial_pose = PoseStamped()
    # initial_pose.header.frame_id = 'map'
    # initial_pose.header.stamp = navigator.get_clock().now().to_msg()
    # initial_pose.pose.position.x = -2.7
    # initial_pose.pose.position.y = 1.53
    # initial_pose.pose.orientation.z = 0.671
    # initial_pose.pose.orientation.w = -0.741
